...
$dodomu = [
    ...
    'image' => 'img src="img/clark-van-der-beken.png"'
];
...
$oeuvres = [$dodomu,$Aashaaheen,$Nightlife,$Lerefuge,$RedWashover,$Chromatics,$DigitalNegative,$Blast,$Hurricane,$Lamareerouge,$Asimilacion,$LaGalaxia,$Puffy,$Mirage,$Blaue];
?>